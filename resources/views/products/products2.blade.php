<x-layout>
    <main>
        <div class="container-fluid bg-trasparent my-4 p-3" style="position: relative;">
            ...
            <h1 style="font-family: 'Arial', sans-serif; font-size: 36px; font-weight: bold; color: #4a4a4a; text-align: center; margin-top: 20px;">
                Always made fresh everyday.
            </h1>
                                ...
                                <div class="card h-100 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        <div class="clearfix mb-3">
                                            <span class="float-start badge rounded-pill bg-primary">{{ $product->getCategory() }}</span>
                                            <span class="float-end price-hp">&#8369;{{ $product->unitPrice }}/{{ $product->unit }}</span>
                                        </div>
