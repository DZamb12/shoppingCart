                        ...
                        <div class="row g-0">
                            <div class="col-lg-8">
                                <div class="p-5">
                                    ...
                                    <div class="card my-4 card-registration card-registration-2 mb-3" style="border-radius: 15px;">
                            ...
                            <div class="col-lg-4 bg-grey">
                                <div class="p-5">
                                    ...
                                    <form method="POST" action="/cart/{{ $product->id }}/destroyall">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-warning btn-lg" data-mdb-ripple-color="dark">Buy</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-lg-4 bg-grey">
                                <div class="p-5">
                                    ...
                                    <hr class="my-4">
                                    <a href="/"><button type="button" class="btn btn-success btn-block btn-lg" data-mdb-ripple-color="dark">Buy</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
